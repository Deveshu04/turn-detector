...
PROMPTS = [
    ...
    # B — complete WITH a mid-sentence filler: hesitate in the middle, but FINISH
    ...
    # E — incomplete: STOP mid-sentence, a genuine thinking pause. Do not finish!
...
def prompt_view(i: int) -> str:
    if i >= len(PROMPTS):
        return ("## ✅ All 30 clips recorded!\n\nTell Claude you're done — "
                "scoring runs from `data/real_eval/`.")
    p = PROMPTS[i]
